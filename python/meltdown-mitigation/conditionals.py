...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    threshold_limit = (10 / 100) * threshold

    if (
        criticality <= threshold + threshold_limit
        and criticality >= threshold - threshold_limit
    ):
        status = 'NORMAL'
    elif criticality < threshold - threshold_limit:
        status = 'LOW'
